...
class ParseSwmm:
    def __init__ (self, filename):
        ...
        self.parser.readfp(ConfParsAdapter(open(self.filename)))
    ...
    def change_roughness(self, id, value):
        self.change_parameter('CONDUITS', id, 'roughness', value)
    ...
    # retorna o valor da key de um id de uma section
...
def main():
    # open swmm file
    saocarlos = ParseSwmm('models/modificado.INP')

    # prototype: change_parameter(id, value)
